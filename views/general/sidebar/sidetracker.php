<?php
$biz = retrieveAndCacheResponse($c_website.'controllers/business.php?data&uid='.$loguserid);
...
<div class="d-flex align-items-center flex-column w-100 mb-8 mb-lg-10">
    ...
    <div class="w-100 bg-light-primary rounded mb-2" style="height: 15px">
        <div class="bg-info rounded" role="progressbar" style="height: 15px; width: <?= $profileCompletion; ?>%;" aria-valuenow="<?= $profileCompletion; ?>" aria-valuemin="0" aria-valuemax="100"></div>
    </div>
    <div class="fw-semibold fs-7 text-gray text-center w-100 mt-auto">
        <span>Account setup progress: <strong><?= $profileCompletion; ?>%</strong></span>
    </div>
</div>
