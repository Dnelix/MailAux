<td class="text-end">
    <div class="d-flex justify-content-end flex-shrink-0">
        <!-- <a href="customers?cid=" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-trigger="hover" title="View details">
